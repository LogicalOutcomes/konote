...
class SuggestionTheme(models.Model):
    """A recurring theme identified from participant suggestions.

    Themes are typically auto-generated by AI during Outcome Insights
    generation (source='ai_generated') and linked to notes automatically.
    Between insight runs, new suggestions are matched to existing themes
    via lightweight keyword matching (Tier 1 auto-link).
    """
    ...
    keywords = models.TextField(
        blank=True, default="",
        help_text="Comma-separated keywords for lightweight auto-linking.",
    )
