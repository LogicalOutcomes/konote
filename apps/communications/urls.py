...
urlpatterns = [
    path("participant/<int:client_id>/quick-log/", quick_log, name="quick_log"),
    ...
    path("participant/<int:client_id>/leave-message/", leave_message, name="leave_message"),
    path("participant/<int:client_id>/messages/", client_messages, name="client_messages"),
    path("participant/<int:client_id>/message/<int:message_id>/read/", mark_message_read, name="mark_message_read"),
]
