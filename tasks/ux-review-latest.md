...
- **[Browser] Responsive Layout** `/participants/5/`
...
- **[Browser] Responsive Layout** `/participants/`
...
- **[Browser] Responsive Layout** `/participants/`
  [mobile] Client list: Touch target too small — <a> "New Participant" is 125x38px (min 44x44)

- **[Browser] Responsive Layout** `/participants/`
  [mobile] Client list: Touch target too small — <select> "All statuses" is 94x36px (min 44x44)

- **[Browser] Responsive Layout** `/participants/`
  [mobile] Client list: Touch target too small — <select> "All Programs" is 125x36px (min 44x44)

- **[Browser] Responsive Layout** `/participants/`
  [mobile] Client list: Touch target too small — <a> "Clear" is 27x18px (min 44x44)
...
|------|-----|--------|--------|
| Home page (find admin link) | `/` | 302 | 1 issue(s) |
...
|------|------|-----|--------|--------|
| Admin | Home page — admin link visible | `/` | 302 | None |
...
- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Skip to main content" is 1x1px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "KoNote" is 69x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <button> "" is 39x13px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Home" is 50x35px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Participants" is 82x35px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <button> "Actions ▾" is 80x28px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Info" is 48x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Plan (1)" is 79x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Notes (1)" is 89x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "History (2)" is 99x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <a> "Analysis" is 72x38px (min 44x44)

- **[INFO]** `/participants/5/` — [mobile] Client detail: Touch target too small — <button> "✎ Edit" is 70x28px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <a> "Skip to main content" is 1x1px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <a> "KoNote" is 69x38px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <button> "" is 39x13px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <a> "New Participant" is 125x38px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <select> "All statuses" is 94x36px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <select> "All Programs" is 125x36px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <a> "Clear" is 27x18px (min 44x44)

- **[INFO]** `/participants/` — [mobile] Client list: Touch target too small — <a> "Jane Doe" is 62x20px (min 44x44)

## Recommendations

### Immediate (Critical)

1. Fix: Expected 200, got 302 on `/`
