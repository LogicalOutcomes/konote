...
**15. IMPROVE-P-5 — Add breadcrumbs to plan-goal-create**
- From satisfaction report (batch AA). DS1b uses browser back button constantly when confused — breadcrumbs (Participants > Jane Doe > Plan > Add Goal) would give a clearer escape path. Currently only "Cancel" provides navigation back.
- **Note:** This ticket was in the batch AA satisfaction report but dropped during consolidation into the tickets file.

**16. Already tracked — no new tickets needed**
...
**Net new items for TODO.md: 15** (4 Tier 1, 8 Tier 2, 3 Tier 3)
...
*21 tickets filed + 1 recovered from satisfaction report, 5 deduplicated against Round 7 scenario plan, 15 net new for TODO*
*4 Tier 1 (fix now), 8 Tier 2 (fix soon), 3 Tier 3 (backlog), 2 TEST (qa-scenarios)*
