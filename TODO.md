...
- [ ] Discuss: are Design Rationale Records (DRRs) working well as a practice? Should we keep using them or change the format? — GK (PROCESS-DRR1)
- [ ] Discuss: Use the `convening-experts` and `review-session` commands for our workflow — GK (PROCESS-EXPERT-PANEL1)
