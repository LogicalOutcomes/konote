...
How to create, configure, and manage surveys. For staff tasks (assigning surveys, entering responses, viewing results), see [Surveys -- Staff Guide](../surveys.md).

---

## Table of Contents

1. [Turning On Surveys](#turning-on-surveys)
...
6. [Section Scoring](#section-scoring)
7. [Activating a Survey](#activating-a-survey)
8. [Importing a Survey from CSV](#importing-a-survey-from-csv)
9. [Trigger Rules (Automatic Assignment)](#trigger-rules-automatic-assignment)
10. [Shareable Survey Links](#shareable-survey-links)
11. [Closing or Archiving a Survey](#closing-or-archiving-a-survey)
12. [Tips & Common Questions](#tips--common-questions)
...
Repeat for each question you want to add. You can remove a question by clicking the X button next to it.
